...
> [!TIP]
> 将本网站加入书签（收藏本网站），或者[加入吹水群](#联系主人)来了解 Bot 第一动向（可以直接滴滴群主）～记得经常回来看看～
...
> [!WARNING]
> 由于 Bot 频繁被封（原因竟然是 ghs？？？），而且我也部署了 GoCQ 崩溃自动重启脚本，所以 Bot 无响应极有可能是被封号
>
> 注意！Bot 封号后将对某些功能进行阉割（阉掉了什么内容可以来问我）！  
...
~~目前 Bot 的好友与进群请求已改为自动同意，请大家放心添加\~~~  
**防止封号**，随缘手动同意，如果急拉请联系我
...
- 2022.7.17
  - **更新**部分插件
- 2022.6.16
  - **更新**插件[`jikipedia`（梗百科）](#梗百科)
    - 添加指令`梗百科 [查询内容]`，用这个指令也可以搜梗了~
    - 优化查询流程
  - **更新**插件[`GenshinUID（原神UID查询）`](#原神-uid-查询)
- 2022.5.29
  - **停用**插件[`sexpic`（二次元图片）](#最近更新内容)（太容易封号了，这几天凌晨老封，避避风头）
